package com.famnotes.crop.util;
...
import com.famnotes.crop.view.HighlightView;
...
public class CropImage
{
	...
	public CropImage(Context context, CropImageView imageView, int modal)
	{
		mContext = context;
	 ...
	 * in:  bm是一张待探测的图片
	 */
	public void detectionFace(Bitmap bm)
	{
		mBitmap = bm;
		startFaceDetection();
	}
	...
	private void startFaceDetection() {
        ...
        showProgressDialog("Face detecting...", new Runnable() {
            public void run() {
    ...
    final public static String dir="/data/data/com.android.famcircle/";
    public String saveToLocal(Bitmap bm)
    {
    	String path = dir+"head"+modal+".png";
		try {
    ...
    Runnable mRunFaceDetection = new Runnable() {
        ...
        // For each face, we create a HightlightView Rect for it.
        ...
        private Bitmap prepareBitmap() {
            ...
            if (mBitmap.getWidth() > 512) {
                mScale = 512.0F / mBitmap.getWidth(); // CR: F => f (or change  all f to F).
            }
            ...
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    if (mNumFaces > 1) {
                        ...
                        // Toast.makeText(...).show().
                        Toast t = Toast.makeText(mContext, "轻点一张脸开始裁剪。", Toast.LENGTH_SHORT);
                        t.show();
                    }
                }
            });
